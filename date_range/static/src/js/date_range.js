    ...
    instance.web.search.ExtendedSearchProposition.include({
        select_field: function (field) {
            ...
            if (this.is_date) {
                ...
                ds.read_slice(["name"], {}).done(
                    this.proxy("add_date_range_types_operator")
                );
            }
        },
        ...
        date_range_type_operator_selected: function (type_id) {
            ...
            var ds = new instance.web.DataSetSearch(this, "date.range", this.context, [
                ["type_id", "=", parseInt(type_id)],
            ]);
            ds.read_slice(["name", "date_start", "date_end"], {}).done(
                this.proxy("on_range_type_selected")
            );
        },

        on_range_type_selected: function (date_range_values) {
            this.value = new instance.web.search.ExtendedSearchProposition.DateRange(
                this,
                this.value.field,
                date_range_values
            );
    ...
    instance.web.search.ExtendedSearchProposition.DateRange = instance.web.search.ExtendedSearchProposition.Field.extend(
        {
            ...
            on_range_selected: function (e) {
                ...
                new openerp.Model("date.range")
                    .call("get_domain", [[this.get_value()], this.field.name, {}])
