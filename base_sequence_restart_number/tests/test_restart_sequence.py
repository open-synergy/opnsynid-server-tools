...
class RestartSequenceCase(TransactionCase):
    def setUp(self, *args, **kwargs):
        ...
        self.obj_sequence = self.env["ir.sequence"]
    ...
    def test_restart_sequence(self):
        self.obj_sequence.next_by_id(self.sequence.id)
        self.obj_sequence.next_by_id(self.sequence.id)
        self.assertEqual(self.sequence.number_next_actual, 3)
        self.sequence.restart_sequence()
        self.assertEqual(self.sequence.number_next_actual, 1)
    ...
    def test_create_sequence(self):
        ...
        self.assertEqual(len(self.sequence.cron_id), 0)
